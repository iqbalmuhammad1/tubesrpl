...
<section class="section about-page">
	<div class="container">
		<div class="row">
			<div class="col-lg-4">
				<h2 class="title-color">Apapun bentuk pembayaran nya, Dompet Digital solusinya</h2>
			</div>
			<div class="col-lg-8">
				<p>Dompet Digital merupakan website e-wallet yang melakukan transaksi secara online dengan bentuk uang berupa e-money. 
					Dompet Digital bisa diakses tanpa harus mengunduh aplikasi.</p>
			</div>
		</div>
	</div>
</section>
