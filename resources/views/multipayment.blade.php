	...
	<nav class="navbar navbar-expand-lg navigation" id="navbar">
		<div class="container">
		 	 <a class="navbar-brand" href="index.html">
			  	<img src="images\logo-dd.png" alt="" class="img-fluid">
			  </a>
			   ...
			   <li class="nav-item"><a class="nav-link" href="/uangku/about">About</a></li>
			    ...
			    <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown02">
						...
						<li><a class="dropdown-item" href="#multipayment.html">MultiPayment</a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="block text-center">
          ...
          <h1 class="text-capitalize mb-5 text-lg">MultiPayment</h1>
        </div>
      </div>
    </div>
  </div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					...
					<p>Anda bisa melakukan pembayaran kebutuhan sehari - hari secara online dengan mudah</p>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="trans-block mb-5">
					<img src="images\about\listrik.jpg" alt="" class="img-fluid w-100">
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Electricity</h4>
						<p class="mb-4">Lakukan pembayaran listrik dari rumah anda</p>
						<a href="#" class="read-more"> PAY <i class="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="trans-block mb-5">
					<img src="images\about\air.jpg" alt="" class="img-fluid w-100">
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Water</h4>
						<p class="mb-4">Lakukan pembayaran air dari rumah anda</p>
						<a href="#" class="read-more"> PAY <i class="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="trans-block mb-5">
					<img src="images\about\pulsadata.jpg" alt="" class="img-fluid w-100">
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Pulsa dan Data</h4>
						<p class="mb-4">Membeli pulsa dan data secara online dengan mudah</p>
						<a href="#" class="read-more"> PAY <i class="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="trans-block mb-5 mb-lg-0">
					<img src="images\about\delivery.jpg" alt="" class="img-fluid w-100">
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Delivery</h4>
						<p class="mb-4">Pesan apa saja bayar nya dimana aja </p>
						<a href="#" class="read-more"> PAY <i class="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="trans-block mb-5 mb-lg-0">
					<img src="images\about\onlineshopping.jpg" alt="" class="img-fluid w-100">
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Online Shopping</h4>
						<p class="mb-4">Belanja online dimana aja bayar dengan mudah menggunakan Dompet Digital</p>
						<a href="#" class="read-more"> PAY <i class="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="trans-block mb-5 mb-lg-0">
					<img src="images\about\game.jpg" alt="" class="img-fluid w-100">
					<div class="content">
						<h4 class="mt-4 mb-2 title-color">Games</h4>
						<p class="mb-4">Bayar game online dengan mudah pakai Dompet Digital</p>
						<a href="#" class="read-more"> PAY <i class="icofont-simple-right ml-2"></i></a>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-2 col-md-6 col-sm-6">
				<div class="widget mb-5 mb-lg-0">
					...
					<ul class="list-unstyled footer-menu lh-35">
						...
						<li><a href="multipayment.html">MultiPayment</a></li>
						<li><a href="transfer.html">Transfer via Friends</a></li>
					</ul>
				</div>
			</div>
